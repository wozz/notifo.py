...
def send_message(login, pw, msg=None):
    return Notifo(login, pw).send_message(msg)

def send_notification(login, pw, to=None, msg=None, label=None, title=None, uri=None):
